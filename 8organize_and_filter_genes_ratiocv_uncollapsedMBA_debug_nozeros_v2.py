...
cutoff_gene_cv_ratio = 1.6 #coefficient of variation of the ratio of 39/28 for an insert
...
##                                print cv_sc
			...
			if number_sc >= number_inserts_per_allele_needed_to_test and number_sp >= number_inserts_per_allele_needed_to_test:
                ...
                grouped['cv_39_avg_read/28_avg_reads']=grouped.apply(lambda x: getCV(x['gene'],x['allele'],gene_dict),axis=1)
