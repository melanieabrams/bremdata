...
##		print "column names to sum", column_names_to_sum
##		id_grouped = id_idx_grouped.groupby('ID', sort=False).apply(combine_rows_by_summing) #bug is here.  it runs combine_rows_by_summing but gets stuck.
##		id_grouped.replace(to_replace=0.0, value=1.0, inplace=True)
##		print "made it here2"
##		print "id_grouped", id_grouped
##		for each_column in column_names_to_sum:
