...
if __name__ == '__main__':
	...
	#drop_columns = [col for col in all_columns if '_n_' in col] ##CHANGED HERE SO DOESN'T DROP INDIVIDUAL BIOREPS
	drop_columns.extend([col for col in all_columns if '_tr_' in col]) ##STILL DROPS TECH REPS
