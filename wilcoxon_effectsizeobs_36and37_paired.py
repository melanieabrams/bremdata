...
def wilcox(list1,list2):
    wilcox_test = stats.wilcoxon(list1,list2)   # wilcox test on paired data
    two_tailed_pval = wilcox_test[1] 
...
if __name__ == "__main__":
        ...
        wilcox_36and37=wilcox(all36,all37)

        print(wilcox_36and37) #result: 8.29809930635731e-06
