...
'''
resample ranked Supplementary Tirosh 2009 2 outputs by gene,for overall divergence
(enrichment for more allele-and-species-specific expression divergence
...
goi=['YGR098C','YMR168C','YKR054C',
        'YPL174C','YPR164W','YCR042C',
        'YMR016C','YJR135C','YJL025W','YDR443C'] #YLR397C,'YHR023W','YDR180W', and 'YKL134C' not in this dataset

genes_ASE = 'Tirosh_from_Table_S1.csv'

plot=True
savename='Tirosh_overall_divergence'
...
def ParseGenes(genes_ASE):
    '''
    Input: reformatted supplement of tirosh 2009 hs
    ...
    for line in f:
        ...
        log2_sc_sp=abs(log2_sc_sp) #take the absolute values of each gene
