...
min_goi_count=3 #discard GO terms with fewer than this many members in the GOI
...
##    print(rv_dict['GO:0005737'])
    ...
    rv_df.to_csv('resample_v6_goi_go_df_repeatfiltered_min'+str(min_go_count)+'max'+str(max_go_count)+'_mingoi'+str(min_goi_count)+'onlyBioprocess'+str(onlyBioprocess)+'.tsv', sep='\t', index=True)
                 #
##    print(rv_df)
