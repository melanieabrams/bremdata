...
from modified_nxviz_circos_plot import * #here, modified so cmap adjusted from default of qualitative Accent mtatplotlib map.  currently set to a sequential, not qualitative, map: BuPu.
...
#draw
c = CircosPlot(graph=g,figsize=(9,9),node_grouping="class", node_color="class",
...
plt.savefig('circos_44goi_v4_9-30-21.png',dpi=400,bbox_inches='tight')
#plt.show()
