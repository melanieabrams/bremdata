...
# for mann whitney U test, want multiple inserts per allele 
# filters inserts according to number of inserts required in both alleles before we want to test that gene (change below)
# filter inserts according to the coefficient of variation among those inserts (change below)
...
# for all inserts within a given allele, calculate the mean of all the log2(exptl/ctrl) for each insert, "meanexptl_ctrl"
