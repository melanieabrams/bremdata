...
##    print(rv_dict['GO:0005737'])
    ...
    rv_df.to_csv('resample_v4_goi_go_df.tsv', sep='\t', index=True)
##    print(rv_df)
...
if __name__ == "__main__":
    ...
    #resample
    resampleAllGo(go_term_groups,goi,go_terms,essential_count,non_essential_count,n=10000,save_intermediate=save_intermediate)
