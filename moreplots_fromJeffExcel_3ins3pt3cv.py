...
scatterFigName_for3638='36_and_38_MeanStdevScatter.png'
...
genes_to_bar=['YHR023W','YLR397C','YKR054C','YDR180W','YHR166C','YCR042C','YBR136W']

#genes not in dataset (removed from plots): 'YEL030W','YNL027W','YGR098C','YGR198W','YGL205W','YMR168C','YOR151C','YPL174C',
...
def PlotHist(figName,sp_M_dict,sc_M_dict,onlyGOI=False):

    fig=plt.figure(figsize=(20,15))

    spar_ins=[]
    for key in sp_M_dict:
        if onlyGOI==False:
            spar_ins.append(sp_M_dict[key])
        elif key in genes_to_bar:
            spar_ins.append(sp_M_dict[key])
    scer_ins=[]
    for key in sc_M_dict:
        if onlyGOI==False:
            scer_ins.append(sc_M_dict[key])
        elif key in genes_to_bar:
            scer_ins.append(sc_M_dict[key])
    ...
    plt.ylabel('Density of Genes', fontsize=80)
    plt.xlabel('Mean Fitness)', fontsize=80)
    plt.rc('xtick',labelsize=80)
    plt.rc('ytick',labelsize=80)
##            
##    line1=plt.hist(x_sp, color='#F1B629')
##    line2=plt.hist(x_sc, color='#08A5CD')
##
...
def PlotScatter36_38(figName,sp_T_dict_36,sc_T_dict_36,sp_T_dict_38,sc_T_dict_38,onlyGOI=False,justMean=False):
...
def Plot3Bars(figName,dict_36,dict_37,dict_38,normToGen=False,normToMean=False,bound=10):
    '''bar plots of genes of interest' fitness for the allele passed in the dict''' #note: modified from stationary/active plot, hence A and S naming
...
##
########scatterplot of mean/stdev at 36 vs 38
#####whole genome
##PlotScatter36_38("justMean_"+scatterFigName_for3638,sp_M_dict_36,sc_M_dict_36,sp_M_dict_38,sc_M_dict_38,justMean=True)
##
#####only GOI
##PlotScatter36_38("goi_justMean_"+scatterFigName_for3638,sp_M_dict_36,sc_M_dict_36,sp_M_dict_38,sc_M_dict_38,justMean=True,onlyGOI=True)

#PLOT HIST
PlotHist("36_MeanHist.png",sp_M_dict_36,sc_M_dict_36)
PlotHist("37_MeanHist.png",sp_M_dict_37,sc_M_dict_37)
PlotHist("38_MeanHist.png",sp_M_dict_38,sc_M_dict_38)
