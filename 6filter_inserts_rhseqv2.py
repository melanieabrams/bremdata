...
# keeps the insert if passes filtering metric in either exptlC or ctrlC, doesn't need to pass in both
...
#fixed 1/ctrl/2021 so numbers converted to floats for filtering for correct boolean comparisons
...
if __name__ == '__main__':
        ...
        group3.replace(to_replace='None', value=0.0, inplace=True) #replaces ''None' with 0.0 again so the filtering works
        ...
        if filter_strategy == 'coeff':
                ...
                # if br coeffvar of exptl or ctrl is lower than or equal to cutoff, keep
        ...
        if filter_strategy == 'reads':
                ...
                # if norm averaged reads in exptl or ctrl is higher than or equal to read cutoff, keep
        ...
        if filter_strategy == 'both':           
                all_filt_col_float_dict={} #make sure all the columns for boolean comparisons are float type, or it doesn't work
                ...
                all_columns_to_filter_by=columns_to_filter_by+columns_to_filter_by2
