                    ...
                    if sample not in samples_to_exclude:
                            ...
                            if call.gt_type!=None and call.gt_bases!=None:
                                ...
                                if sample in missing_data:
                                        ...
                                        missing_data[sample]=str(pos)
                            pos_line+=","+sample #THIS LINE REPLACES THE ACTUAL ONE BELOW TO MAKE KEY
                            #pos_line+=","+str(allele)
                if 'INDEL' not in pos_line and 'None' not in pos_line:
                        wf.writelines(pos_line+"\n") #omit lines with missing data or indels
##                print(pos_line)
...
if __name__ == '__main__':
        ...
        outfile_name=vcf_filename.split('.')[0]+".shsinput_samplekey"
        errfile_name=vcf_filename.split('.')[0]+".missing_call_log_samplekey"
        main()
