...
goi=['YLR397C','YGR198W','YKL017C','YGR140W','YCR042C','YDR180W','YOR091W','YIL152W','YNR045W','YDR318W']


#hits 37_2.0_1.1_..._10.0_3.0 with sc defect and effect size >0.5 (in both barcoded AND unbarcoded)
#without YNL049C(SFB2) and YAL026C(DRS2) which had artifactual alignments not beginning with start codon
#also removing YMR275C(BUL1)
...
print('NI p={}'.format(resample_med(candidates, df, 'NI', essential_genes, direction='less_than', graph=False,n=10000,figName='resampling_distribution_MK.png')))
