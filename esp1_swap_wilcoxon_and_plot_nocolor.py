...
strain_key={'62':'Sp,WT',
           '68':'Sc,WT',
           '98':'ESP1 full swap',
           '339':'ESP1 promoter swap',
           '407':'ESP1 partial swap',
           '413':'ESP1 coding swap (less verified)',
           '414':'ESP1 coding swap'}
...
def plotOnePlot(temp, temp_data,significant_strains):
    ...
    for strain in strains:
        ...
        labels.append(strain_key[strain])
    #print(y)
    ...
    plt.xlabel('Strain (Background, Swap)', fontsize=fontsize)

    plt.tight_layout()

    plt.savefig(temp+"_esp1_swaps_barplot_nocolor.png")
