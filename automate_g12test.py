...
from resample_g1 import * #both scripts must be in the same directory; otherwise change path here.  Resample g1 and g12 are the same script, pulling the same column of their respective rank files, g2g1 pulls from the second column.
#the script is the same as automate-g1_test script, but uses the ranked file with g12 as the first column after gene and g2g1 as second
